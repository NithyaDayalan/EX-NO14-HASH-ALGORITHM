...
```
### Output :
<img width="494" height="110" alt="image" src="https://github.com/user-attachments/assets/82a0d989-3d04-48a0-8dcf-ba28992215f6" />

### Result :
Thus, the Hash algorithm is implemented and executed successfully using C program.
